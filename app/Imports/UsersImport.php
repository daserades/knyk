...
class UsersImport implements ToModel, WithHeadingRow
{
    public function model(array $row)
    {
        ...
        $name= explode('-',$a);
        $new=pattern::where('design_name','like','%'.$name[0].'%')->first();
            echo $new;
            // $array['design_name']=$name[0];
            // $array['epi'] = $epi;
            // $array['reed_space'] = $reedspace;
            // $array['finish_width']=$finish_width;
            // $array['ppi']=$ppi;
            // $array['total_dents']=$total_dents;
            // $array['total_ends']=$total_ends;
            // $array['grey_construction']=$grey_construction;
            // $array['grey_construction1']=$grey_construction1;
            // $array['grey_construction2']=$grey_construction2;
            // $array['finish_construction']=$finish_construction;
            // $array['finish_construction1']=$finish_construction1;
            // $array['finish_construction2']=$finish_construction2;
            // $array['reed_count']=$reed_count;
            // $array['average_dent']=$average_dent;
            // $array['gray_width']=$gray_width;
            // $array['gray_glm']=$gray_glm;
            // $array['finish_glm']=$finish_glm;
            // $array['warp_pattern']=$warp_pattern;
            // $array['weft_pattern']=$weft_pattern;
            // $array['weft_total']=$weft_total;
            // $array['draft_total']=$draft_total;
            // $array['draft_total1']=$draft_total1;
            // $array['draft_total2']=$draft_total2;
            // $array['pegptan_total']=$pegptan_total;
            // $array['warp_total']=$warp_total;
            // $array['aciklama']=$aciklama;
          if (empty($new))
          {
            // pattern::create($array->all());
            pattern::create([
            'design_name'=>$name[0],
            'epi' => $epi,
        ...
        $pattern=pattern::where('design_name','like','%'.$name[0].'%')->first();
        $patterndetail= patterndetail::where([['variant_no',$variant_no],['pattern_id',$pattern->id]])->first();
        ...
        for ($i=1; $i <= 15; $i++){
           $atki = data_get($row, 'weft'.$i.'_yarn_name');
             ...
             $cno=preg_split('#(?<=\d)(?=[a-z])#i',@$yhn[1]);
                 if (isset($atki) ) 
                 {
                    $patterndetail= patterndetail::create([
      ...
      $patterncolor= patterncolor::where([['variant_no',$variant_no],['patterndetail_id',$patterndetail->id],['pattern_id',$pattern->id]])->first();
