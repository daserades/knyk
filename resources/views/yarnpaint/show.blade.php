        ...
        <div class="col-md-auto">
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <tr>
                            <td></td>
                            <td>Firma  :{{ $yarnpaint->company->name  ?? ''}}</td>
                            <td>No  :{{ $yarnpaint->no ?? '' }}</td>
                            <td colspan="7">Sipariş No :{{ $yarnpaint->order->no ?? '' }}</td>
                        </tr>
                    			<tr>
                            <div class="col-md-6">
                          	<th></th>
                        ...
                        @isset($yarnpaint->yarnpaintdetail)
                        @foreach($yarnpaint->yarnpaintdetail as $list)
