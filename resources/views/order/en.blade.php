...
<div class="row">
        ...
        <td width="90%" rowspan="80" align="center" valign="middle"><strong>ORDER DETAILS</strong></td>
     ...
     <table class="table-striped table-hover table-sm" border="1" >
      <tr>
        <td width="184" align="center"><div align="center"><strong>Order Number</strong></div></td>
        <td width="184" align="center"><div align="center"><strong>Company Name</strong></div></td>
        <td width="184" align="center"><div align="center"><strong>Company Official</strong></div></td>
        <td width="184" align="center"><div align="center"><strong>Order Date</strong></div></td>
       </tr>
      ...
      <table class="table-striped table-hover table-sm" border="1" >
      <tr>
        <td width="736" align="center"><div align="center"><strong>Order Description</strong></div></td>
        </tr>
    </table> 
    <table class="table-striped table-hover table-sm" border="1" >
...
<table class="table-striped table-hover table-sm" border="1" >
      <tr>
        <td></td>
        <td width="736" align="center"><strong>Order Clauses</strong></td>
        ...
        @foreach ($order->orderitem as $clauses)
            <tr>                                
              <td>{{$loop->iteration}} </td>
                <td>{{ $clauses->contractitem->english ?? ''}}</td>
            </tr>
        @endforeach
</table>
