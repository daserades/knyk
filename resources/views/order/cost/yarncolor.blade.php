...
<form method="POST" action="{{ route('cost.store') }}" name="form" id="form">
  ...
  <input type="hidden" name="article">
    <input type="hidden" name="ordertype_id" value="2">
        <tr>
        ...
        <tr>
          ...
          <td width="244" align="left"><input type="text" name="no" id="no"  size="10" required></td>
...
<br>
  <table border="1" cellpadding="0" cellspacing="0" width="800" >
      ...
      <tr>
        ...
        <td id="plan_musteri"><strong>İPLİK BOYA MALİYET</strong></td>
        <td height="5" id="plan_musteri"><input type="text" name="oimc" id="oimc" value="" size="10" autocomplete="off">
          <select name="oimc_kur" id="oimc_kur" class="required" size="1">
            @foreach ($exchange as $list)
            <option value="{{$list->id}}">{{$list->name}}</option>
            @endforeach
        </select></td>
      ...
      <tr>
        ...
        <td id="plan_musteri53"><input type="text" name="term" id="term2" value="0" size="10">
        ...
        <td height="5" id="plan_musteri53"><input type="text" name="vf" id="vf" value="" size="10" autocomplete="off">%</td>
      </tr>
      <tr>
        ...
        <td height="5" id="plan_musteri5"><input type="text" name="gbp" id="gbp" value="" size="10" autocomplete="off">GBP</td>
      </tr>
      <tr>
        <td><strong>DOLAR</strong> $</td>
        <td id="plan_musteri6"><input type="text" name="usd" id="usd" value="" size="10" autocomplete="off"> DOLAR</td>
      ...
      <tr>
        <td><strong>ÇÖZGÜ İPLİK BOYA FİRESİ</strong></td>
        <td id="plan_musteri7"><input type="text" name="cbf" id="cbf" value="5" size="10" autocomplete="off">%</td>
        ...
        <label id="cgr" name="cgr"></label> </td>
      </tr>
      <tr>
        <td><strong>ATKI İPLİK BOYA FİRESİ</strong></td>
        <td id="plan_musteri69"><input type="text" name="abf" id="abf" value="5" size="10" autocomplete="off">%</td>
        ...
        <label id="agr" name="agr"></label></td>
      </tr>
      <tr>
        <td><strong>KAR MARJI</strong></td>
        <td id="plan_musteri8"><input type="text" name="kar" id="kar" value="0" size="10" class="required">%</td>
        <td id="plan_musteri8"><strong>TERBİYE FİRESİ</strong></td>
        <td height="5" id="plan_musteri8"><input type="text" name="terf" id="terf" value="10" size="10" autocomplete="off">%</td>
      </tr>
  </table>
<br>
...
<script src="{{ asset('js/jquery-ui.js') }}"></script>
  <script type="text/javascript"> 
                ...
                // console.log(res); 
                 // $("input[name='cne']").empty(); 
                  for (i=0; i < kayitSay; i++)
                    ...
                    taren= taren.replace(',','.');
                    // alert(cbf);
                    cgr=  ((csik*taren)/1.693/cne*1.06*1.03*(cbf/100+1));
                    agr=  ((asik*taren)/1.693/ane*1.06*1.03*(abf/100+1));
    ...
    // });
      // select: function( event, ui ) {
      //  location.replace('&no='+ui.item.article);
      // }
  </script>
  @endsection