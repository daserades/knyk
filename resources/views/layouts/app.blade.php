                        ...
                        @else
                         <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="{{ route('yarn.index') }}">İplik Giriş-Çıkış</a>
                                <a class="dropdown-item" href="{{ route('yarntwist.index') }}">İplik Büküm Talimatı</a>
                                <a class="dropdown-item" href="{{ route('yarnpaint.index') }}">İplik Boya Talimatı</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
